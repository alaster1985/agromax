...
<main>
    <section class="contacts container">
        <div class="row">
            ...
            <div class="col-sm-6">
                <h2 class="contacts__title">Please contact:</h2>
                <p class="contacts__link-wrapper">
                    <h3 class="contacts__title-link">About membership in professional associations and business events:</h3>
                    <a class="contacts__link" href="mailto:marketing@agromax.farm">marketing@agromax.farm</a>
                </p>
                <p class="contacts__link-wrapper">
                    <h3 class="contacts__title-link">About organizational issues and job:</h3>
                    <a class="contacts__link" href="mailto:office@agromax.farm">office@agromax.farm</a>
                </p>
                <p class="contacts__link-wrapper">
                    <h3 class="contacts__title-link">About strategic partnership:</h3>
