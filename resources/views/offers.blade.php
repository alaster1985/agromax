            ...
            @foreach($lots as $lot)
                <div itemscope itemtype="http://schema.org/Product">
                    <div class="offers__item col-sm-4 col-md-3">
                        ...
                        <h3 class="offers__title" itemprop="name"><strong>{{$lot->product_name ?? $lot->product->name}}</strong></h3>
                        <p class="products__desc" itemprop="description">{{$lot->description ?? \App\Product::find($lot->product_id)->description}}</p>
